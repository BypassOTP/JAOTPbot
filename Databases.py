...
def create_user_test(userid):
    ...
    sql = f"Insert into UserData (user_id,bank_name,phone_no,otp_code,Recording_url,card_number,card_cvv,card_expiry,account_number,atm_pin, expiry_date, option1, option2, option3, option4, option_number, numbers_collected1, numbers_collected2,voice,dl_number, ssn_number, app_number, script, targetname)values('{userid}','Notavailable','Notavailable',0,'Notavailable',0,0,0,0,0,'{exp_day_test}','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable')"
    c.execute(sql)
    conn.commit()
...
def create_user_7days(userid):
    ...
    sql = f"Insert into UserData (user_id,bank_name,phone_no,otp_code,Recording_url,card_number,card_cvv,card_expiry,account_number,atm_pin, expiry_date, option1, option2, option3, option4, option_number, numbers_collected1, numbers_collected2,voice,dl_number, ssn_number, app_number, script, targetname)values('{userid}','Notavailable','Notavailable',0,'Notavailable',0,0,0,0,0,'{exp_day_7days}','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable')"
    c.execute(sql)
    conn.commit()
...
def create_user_1month(userid):
    ...
    sql = f"Insert into UserData (user_id,bank_name,phone_no,otp_code,Recording_url,card_number,card_cvv,card_expiry,account_number,atm_pin, expiry_date, option1, option2, option3, option4, option_number, numbers_collected1, numbers_collected2,voice,dl_number, ssn_number, app_number, script, targetname)values('{userid}','Notavailable','Notavailable',0,'Notavailable',0,0,0,0,0,'{exp_day_1month}','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable')"
    c.execute(sql)
    conn.commit()
...
def create_user_3months(userid):
    ...
    sql = f"Insert into UserData (user_id,bank_name,phone_no,otp_code,Recording_url,card_number,card_cvv,card_expiry,account_number,atm_pin, expiry_date, option1, option2, option3, option4, option_number, numbers_collected1, numbers_collected2,voice,dl_number, ssn_number, app_number, script, targetname)values('{userid}','Notavailable','Notavailable',0,'Notavailable',0,0,0,0,0,'{exp_day_3months}','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable')"
    c.execute(sql)
    conn.commit()
...
def create_user_lifetime(userid):
    ...
    sql = f"Insert into UserData (user_id,bank_name,phone_no,otp_code,Recording_url,card_number,card_cvv,card_expiry,account_number,atm_pin, expiry_date, option1, option2, option3, option4, option_number, numbers_collected1, numbers_collected2,voice,dl_number, ssn_number, app_number, script, targetname)values('{userid}','Notavailable','Notavailable',0,'Notavailable',0,0,0,0,0,'{exp_day_lifetime}','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable','Notavailable')"
    c.execute(sql)
    conn.commit()
...
def save_targetname(targetname, userid):
    c.execute("UPDATE UserData SET targetname = ? WHERE user_id = ?",(targetname, userid))
    conn.commit()
...
def fetch_targetname(userid):
     c.execute(f"SELECT targetname FROM UserData WHERE user_id = '{userid}'")
     targetname = str(c.fetchone()[0])
     conn.commit()
     return targetname
